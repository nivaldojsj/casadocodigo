  ...
  <header id="layout-header">
        ...
        <ul id="variants" class="clearfix">
        	...
        	<c:forEach items="${produto.precos}" var="tipoPreco" varStatus="status">
              <li class="buy-option">
                ...
                <small class="compare-at-price">R$ ${tipoPreco.valor}</small>
                <p class="variant-price">R$ ${tipoPreco.valor }</p>
    ...
    <div class="container">
      ...
      <section class="data product-detail">
        ...
        <p></p>
        <p>
        	Data de publicação: <fmt:formatDate pattern="dd/MM/yyyy" 
                    ...
                    <form
                        ...
                        <ul>
                            <li>
                            	...
                            	<input type="email" name="entry.0.single" value="" 
                            	class="ss-q-short" id="entry_0" placeholder="seu@email.com"/>
                            </li>
                            <li>
